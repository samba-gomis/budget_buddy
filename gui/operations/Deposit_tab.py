...
def build_deposit_tab(parent, account_id: int, on_done=None):
    """Builds the deposit form inside the given tab."""
    ...
    desc_entry = ctk.CTkEntry(parent, placeholder_text="e.g. Monthly salary",
                              width=300)
    ...
    def confirm():
        ...
        try:
            ...
            compte.deposer(amount=amount,
                           description=desc_entry.get().strip() or "Deposit")
    ...
    ctk.CTkButton(parent, text="Confirm deposit",
